...
public class BinarySearchNameAdres {
	// Function to implement binary search
 
	// Iterative Binary Search (changed from recursive as required)
...
public static Scanner input = new Scanner(System.in);
	...
	public static void main(String[] args)throws Exception {
		...
		//Display data on the array SORTED
				...
				System.out.println("ENTER GRADE TO SEARCH: " );   // Note: prompt kept as in original, but we search by name
