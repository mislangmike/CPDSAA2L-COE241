...
public static Scanner input = new Scanner(System.in);
	...
	public static void main(String[] args)throws Exception {
		...
		//Display data on the array SORTED
				...
				int key=input.nextInt(); //where: key variable is the name to search in the array
				int h=grade.length-1;//the size array
				int low=0;
				
				int pos=binarySearch(grade, low,h, key);
				
				//DISPLAY THE ELEMENTS
				
					if(pos!=-1)
					{
						System.out.println("GRADE "+key + " is found...");
					...
					{
						System.out.println("GRADE " + key +" not found...");
					}
